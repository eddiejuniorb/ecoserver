...
storeRoute.get('/hot-update', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const resp = await prisma.updateInfo.findMany();
    return res.status(200).send(resp[0] || { message: "", enabled: false })
}))

storeRoute.post('/hot-update', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
...
storeRoute.get('/header', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const resp = await prisma.smallHeader.findMany({ orderBy: { iat: 'desc' } })
    return res.status(200).send(resp)
}))

storeRoute.post('/header', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const { data } = req.body
...
storeRoute.get('/banner', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const resp = await prisma.banner.findMany()
    return res.status(200).send(resp)
}))

storeRoute.post('/banner', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const { data } = req.body
...
storeRoute.get('/on-sale', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const resp = await prisma.on_sales.findMany({ orderBy: { iat: 'desc' } });
    return res.status(200).send(resp)
}))

storeRoute.post('/on-sale', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const { data } = req.body
...
storeRoute.get('/promotional', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const resp = await prisma.promotional.findMany();
    return res.status(200).send(resp)
}))

storeRoute.post('/promotional', verifyToken(['admin'], 'admin'), asyncError(async (req, res) => {
...
storeRoute.get('/faq', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
...
storeRoute.post('/faq', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
...
storeRoute.delete('/faq', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
    const { id } = req.query
...
storeRoute.get('/seo', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
...
storeRoute.post('/seo', verifyToken(['admin', 'cashier'], 'admin'), asyncError(async (req, res) => {
...
storeRoute.get('/store-settings', verifyToken(['admin',], 'admin'), asyncError(async (req, res) => {
    const resp = await prisma.storeSetting.findFirst()
    return res.status(200).send(resp || { cash_on_delivery: true, paystack: true })
}))

storeRoute.post('/store-settings', verifyToken(['admin'], 'admin'), asyncError(async (req, res) => {
